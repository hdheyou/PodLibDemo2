#
#  Be sure to run `pod spec lint PodLibDemo2.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "heyou" => "hdheyou@126.com" }
  # Or just: spec.author    = "heyou"
  # spec.authors            = { "heyou" => "heyou@himobi.net" }
  # spec.social_media_url   = "https://twitter.com/heyou"
